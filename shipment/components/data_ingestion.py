...
class DataIngestion:
    ...
    def split_data_as_train_test(self, df: DataFrame) -> Tuple[DataFrame, DataFrame]:
        ...
        try:
            ...
            os.makedirs(
                self.data_ingestion_config.DATA_INGESTION_ARTIFCATS_DIR, 
                exist_ok=True
                )
            ...
            os.makedirs(
                self.data_ingestion_config.TRAIN_DATA_ARTIFACT_FILE_DIR, 
                exist_ok=True
                )
            ...
            os.makedirs(
                self.data_ingestion_config.TEST_DATA_ARTIFACT_FILE_DIR, 
                exist_ok=True
                )
