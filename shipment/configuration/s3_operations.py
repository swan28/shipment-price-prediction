...
class S3Operation:
    ...
    def is_model_present(self, bucket_name: str, s3_model_key: str) -> bool:
        ...
        try:
            ...
            file_objects = [file_object for file_object in bucket.objects.filter(Prefix=s3_model_key)] # here modelkey refers to model name
    ...
    def read_csv(self, filename: str, bucket_name: str) -> DataFrame:
        ...
        Description :   This method reads the csv
